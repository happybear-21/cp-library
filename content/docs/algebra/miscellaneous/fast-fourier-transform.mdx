...
One option would be to perform multiple number theoretic transforms with different prime numbers of the form  $c 2^k + 1$ , then apply the Chinese Remainder Theorem to compute the final coefficients.
