...
<Callout title="Definition" type="info">
Complementary to convergents, we define the complete quotients as  $s_k = [a_k; a_{k+1}, a_{k+2}, \dots]$ .
...
<Callout title="Recurrence" type="info">
...
<Callout title="Deviations" type="info">
...
<Callout title="Lattice Hulls" type="info">
...
<Callout title="Best Approximations" type="info">
...
Fractions  $\frac{0}{1}$  and  $\frac{1}{0}$  are "virtually" kept on the left and right sides of the tree correspondingly. Then the fraction in a node is a mediant  $\frac{a+c}{b+d}$  of two fractions  $\frac{a}{b}$  and  $\frac{c}{d}$  above it.
...
![](https://upload.wikimedia.org/wikipedia/commons/1/18/Stern-brocot-index.svg)
...
<Callout title="Comparing Continued Fractions" type="info">
...
<Callout title="Best Inner Point" type="info">
...
<Callout title="GCJ 2019, Round 2 - New Elements: Part 2" type="info">
...
![](https://upload.wikimedia.org/wikipedia/commons/8/82/Calkin%E2%80%93Wilf_tree.svg)
...
<Callout title="Detailed Explanation" type="info">
...
<Callout title="Extened Euclidean?" type="info">
...
## Linear Fractional Transformers
...
<Callout title="DMOPC '19 Contest 7 P4 - Bob and Continued Fractions" type="info">
...
<Callout title="Linear fractional transformation of a continued fraction" type="info">
Let  $L(x) = \frac{ax+b}{cx+d}$ . Compute the continued fraction representation  $[b_0; b_1, \dots, b_m]$  of  $L(A)$  for  $A=[a_0; a_1, \dots, a_n]$ .

This allows to compute  $A + \frac{p}{q} = \frac{qA + p}{q}$  and  $A \cdot \frac{p}{q} = \frac{p A}{q}$  for any  $\frac{p}{q}$ .
</Callout>
...
<Callout title="Continued fraction arithmetics" type="info">
...
<Callout title="Quadratic Irrationality" type="info">
...
<Callout title="Tavrida NU Akai Contest - Continued Fraction" type="info">
...
<Callout title="Explanation" type="info">
...
meaning that  $\vec r$  and  $s_k \vec r_{k-1} + \vec r_{k-2}$  are collinear (that is, have the same slope coefficient). Taking the pseudoscalar product of both parts with  $\vec r$ , we get 
```math
...
<Callout title="Nose stretching algorithm" type="info">
...
<Callout title="Convex Hull Under the Line" type="info">
...
![](https://upload.wikimedia.org/wikipedia/commons/b/b1/Lattice-hull.svg)
...
<Callout title="Timus - Crime and Punishment" type="info">
...
<Callout title="June Challenge 2017 - Euler Sum" type="info">
...
<Callout title="NAIPC 2019 - It's a Mod, Mod, Mod, Mod World" type="info">
...
<Callout title="Library Checker - Sum of Floor of Linear" type="info">
...
<Callout title="OKC 2 - From Modular to Rational" type="info">
...
Equivalent formulation: Find  $x$  that delivers the minimum of  $Ax \;\bmod\; M$  for  $1 \leq x \leq N$ .
</Callout>
