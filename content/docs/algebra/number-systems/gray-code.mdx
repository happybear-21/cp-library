...
\begin{aligned}
n_k &= g_k, \\
n_{k-1} &= g_{k-1} \oplus n_k = g_{k-1} \oplus g_k, \\
n_{k-2} &= g_{k-2} \oplus n_{k-1} = g_{k-2} \oplus g_{k-1} \oplus g_k, \\
n_{k-3} &= g_{k-3} \oplus n_{k-2} = g_{k-3} \oplus g_{k-2} \oplus g_{k-1} \oplus g_k, \\
&\vdots
\end{aligned}
```
